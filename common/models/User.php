...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'username'             => Yii::t('yii2-cms', 'Username'),
            'email'                => Yii::t('yii2-cms', 'Email'),
            'full_name'            => Yii::t('yii2-cms', 'Full Name'),
            'display_name'         => Yii::t('yii2-cms', 'Display Name'),
            'password_hash'        => Yii::t('yii2-cms', 'Password Hash'),
            'password_reset_token' => Yii::t('yii2-cms', 'Password Reset Token'),
            'auth_key'             => Yii::t('yii2-cms', 'Auth Key'),
            'status'               => Yii::t('yii2-cms', 'Status'),
            'created_at'           => Yii::t('yii2-cms', 'Registered'),
            'updated_at'           => Yii::t('yii2-cms', 'Updated'),
            'login_at'             => Yii::t('yii2-cms', 'Last Activity'),
            'role'                 => Yii::t('yii2-cms', 'Role'),
            'password'             => Yii::t('yii2-cms', 'Password'),
            'password_repeat'      => Yii::t('yii2-cms', 'Repeat Password'),
            'password_old'         => Yii::t('yii2-cms', 'Old Password'),
        ];
    }
    ...
    public function passwordValidation()
    {
        ...
        if (!$user || !$user->validatePassword($this->password_old)) {
            $this->addError('password_old', Yii::t('yii2-cms', 'The old password is not correct.'));
        }
    }
