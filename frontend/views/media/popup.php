...
use frontend\assets\MediaPopupAsset;
    ...
    <div id=content-wrapper">
        <div id="nav-tabs-custom" class="nav-tabs-custom">
            <?= Nav::widget([
                'items'        => [
                    [
                        'label'       => '<i class="fa fa-plus"></i> <span>'. Yii::t('yii2-cms', 'Add New Media') . '</span>',
                        'url'         => '#add-new-media',
                        'linkOptions' => [
                    ...
                    [
                        'label'       => '<i class="fa fa-folder-open"></i> <span>'. Yii::t('yii2-cms', 'Media Library'). '</span>',
                        'url'         => '#media-library',
                        'linkOptions' => [
            ...
            <div id="media-library" class="tab-pane active">
                <?php $form = ActiveForm::begin([
                    ...
                    'options' => [
                        ...
                        'data-url' => Url::to(['/media/ajax-upload','post_id' => isset($post) ? $post->id : null,]),
                    ],
                ]) ?>
                ...
                <div class="form-group">
                    <?= Html::textInput('title', null, [
                        'placeholder' => Yii::t('yii2-cms', 'Search'),
                ...
                <div id="content-footer" class="content-footer">
                    <?= Html::button(Yii::t('yii2-cms', 'Insert Media'), [
                        'id'              => 'insert-media',
