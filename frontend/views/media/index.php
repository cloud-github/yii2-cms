...
$this->title = Yii::t('yii2-cms', 'Media');
    ...
    <div class="media-index">
        ...
        <div class="form-inline grid-nav" role="form">
            <div class="form-group">
                ...
                <?= Html::button(Yii::t('yii2-cms', 'Apply'), ['class' => 'btn btn-flat btn-warning bulk-button', 'data-type' => 'DELETE']); ?>
                <?= Html::a(Yii::t('yii2-cms', 'Add New Media'), ['create'], ['class' => 'btn btn-flat btn-primary']) ?>
        ...
        <?= GridView::widget([
            ...
            'columns'      => [
                ...
                [
                    'attribute' => Yii::t('yii2-cms', 'Preview'),
                    'format'    => 'raw',
                ...
                [
                    'label'  => Yii::t('yii2-cms', 'File Name'),
                    'format' => 'html',
                    'value'  => function ($model) {
                        /* @var $model common\models\Media */
                        $metadata = $model->getMeta('metadata');
